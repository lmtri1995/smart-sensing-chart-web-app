            ...
            <div className="oee-main">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-4 align-self-center"><DoughnutChart loading={loading} customTooltips={customChartTooltips} labels={["Quality", ""]} data={qualityChartData} centerText={`Quality\n${qualityNumber}%`}/></div>
                    </div>
                </div>
            </div>
        )
